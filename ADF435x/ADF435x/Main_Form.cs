...
namespace ADF435x
{
    public partial class Main_Form : Form
    {
        ...
        int SDTestmodesBox;
        int ICPADJENBox;
        int FeedbackSelectBox = 1;
        int PrescalerBox = 1;
        int PhaseAdjustBox = 0;
        ...
        private void BuildRegisters()
        {
            ...
            RFoutBox.Text = (((INT + (FRAC / MOD)) * (double)PFDFreq / Convert.ToInt16(DivBox.Text)) * ((FeedbackSelectBox == 1) ? 1 : Convert.ToInt16(DivBox.Text))).ToString();
            ...
            if (ADF4351.Checked)
            {
                Reg[0] = (uint)(
                    ...
                    0);
                Reg[1] = (uint)(
                    PhaseAdjustBox * Math.Pow(2, 28) +
                    PrescalerBox * Math.Pow(2, 27) +
                ...
                Reg[4] = (uint)(
                    FeedbackSelectBox * Math.Pow(2, 23) +
            ...
            if ((PhaseAdjustBox == 1) && (EnableGCD.Checked))
            {
        ...
        private void Limit_Check()
        {
            ...
            if ((ADF4351.Checked) && (PrescalerBox == 0) && (RFout > 3600))
            {
        ...
        private void FillMainControlsFromRegisters(object sender, EventArgs e)
        {
            ...
            if (ADF4351.Checked)
            {
                ...
                PhaseAdjustBox = (R1 >> 28) & 0x1;
                PrescalerBox = (R1 >> 27) & 0x1;
        ...
        private void DeviceSelectorGroup_Enter(object sender, EventArgs e)
        {

        }

        private void SweepGroupBox_Enter(object sender, EventArgs e)
        {

        }

        private void SweepStartBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void FeaturesTab_Click(object sender, EventArgs e)
        {

        }

        private void TestmodesGroup_Enter(object sender, EventArgs e)
        {
        ...
        private void SweepHopTab_Click(object sender, EventArgs e)
        {

        }

        //private void R0HexBox_TextChanged(object sender, EventArgs e)
        //{
        ...
        private void R0Box_TextChanged(object sender, EventArgs e)
        {

        }

        private void R1HexBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void UsingSPISELBLabel_Click(object sender, EventArgs e)
        {
        ...
        private void SweepCurrent_TextChanged(object sender, EventArgs e)
        {
        ...
        private void DirectWriteBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void ReadbackComparatorBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void USBselector_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void HopGroupBox_Enter(object sender, EventArgs e)
        {
        ...
        void importADIsimPLL(string ADIsimPLL_import_file)
        {
            ...
            if (ADF4351.Checked)
            {
                ...
                if (data["ChipSettings"]["VCODivOutsideLoop"] != null)
                    FeedbackSelectBox = Convert.ToInt16(data["ChipSettings"]["VCODivOutsideLoop"]);

                if (data["ChipSettings"]["Prescaler"] != null)
                    PrescalerBox = (Convert.ToInt16(data["ChipSettings"]["Prescaler"]) / 4) - 1;
